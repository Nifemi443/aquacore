...
const appNavItems: AppNavItem[] = [
  ...
  { label: "Fish Batches", href: "#", icon: <MiniIcon type="batch" /> },
  { label: "Today's Feedings", href: "#", icon: <MiniIcon type="feed" /> },
  { label: "Feed Inventory", href: "#", icon: <MiniIcon type="inventory" /> },
  { label: "Water Records", href: "#", icon: <MiniIcon type="water" /> },
