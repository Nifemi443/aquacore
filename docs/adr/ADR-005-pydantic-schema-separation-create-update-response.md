# ADR-005: Pydantic schema separation (Create/Update/Response)
...
**Pydantic schema separation (Create/Update/Response)**

## Alternatives Considered

- Single schema per entity

## Rationale

API stability, security, OpenAPI clarity.
